 ...
 *
 * [date] 날짜 선택 field
 *   <SelectField variant="date" value="2026. 07. 05" onClick={openCalendar} />
 *
 * [purpose] 촬영 목적 선택 field
 *   <SelectField variant="purpose" value="프로필 촬영" onClick={openPurposeSheet} />
 *
 * [placeholder] 값이 없는 상태
 *   <SelectField variant="purpose" placeholder="목적 선택" />
 */
